...
# installed.
TCL_PREFIX='/opt/anaconda1anaconda2anaconda3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/anaconda1anaconda2anaconda3'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,-rpath,/opt/anaconda1anaconda2anaconda3/lib -L/opt/anaconda1anaconda2anaconda3/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/anaconda1anaconda2anaconda3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/anaconda1anaconda2anaconda3/include'
...
TCL_PACKAGE_PATH='/opt/anaconda1anaconda2anaconda3/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/anaconda1anaconda2anaconda3/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1535485056075/work/tcl8.6.8/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/anaconda1anaconda2anaconda3/lib/libtclstub8.6.a'
